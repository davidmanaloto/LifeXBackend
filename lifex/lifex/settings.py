...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'lifex.exceptions.custom_exception_handler',
}
...
if DEBUG:
    ...
    # SMTP Production Settings (Placeholder)
    ...
    DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'noreply@lifex.com')